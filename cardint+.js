(function () {
    ...
    function renderSeasonBadge(cardHtml, tmdbData) {
        ...
        if (currentSeason && last.season_number > 0) {
            ...
            var stateClass = isComplete ? 'season-complete' : 'season-airing';
            ...
            var bgColor = isComplete ? 'rgba(230, 126, 34, 0.9)' : 'rgba(170, 20, 20, 0.8)';
            
            // Замінюємо іконку на текст сезону
            typeBadge.innerHTML = text;
            typeBadge.classList.add('card__type--season');
            typeBadge.classList.remove('season-complete','season-airing');
            typeBadge.classList.add(stateClass);
    ...
    function start() {
        ...
        style.innerHTML =
            ...
            '.card__type { position: absolute !important; left: 0 !important; top: 0 !important; width: auto !important; height: auto !important; line-height: 1 !important; padding: 0.3em !important; border-radius: 0.75em 0 0.75em 0 !important; background: rgba(72, 104, 156, 0.84) !important; display: flex !important; align-items: center; justify-content: center; z-index: 2; color: #fff !important; transition: background 0.3s !important; }' +
            ...
            '.card__type.card__type--season.season-complete { background: rgba(52,176,109,0.84) !important; }' +
